...
DEPENDS += "gst-plugins-base libmusicbrainz tremor librsvg faac"
...
EXTRA_OECONF += "--disable-examples --disable-experimental --disable-sdl --disable-cdaudio \
                 --with-plugins=musicbrainz,wavpack,ivorbis,mpegvideoparse,faac --disable-vdpau --disable-apexsink"
