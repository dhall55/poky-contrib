...
SRC_URI = "file://bbxm-audio \
           file://asound.state \
          "

INITSCRIPT_NAME = "bbxm-audio"
INITSCRIPT_PARAMS = "defaults 90"

do_install() {
    install -d ${D}${sysconfdir} \
        ${D}${sysconfdir}/init.d
    install -m 0755 ${WORKDIR}/asound.state ${D}${sysconfdir}
    install -m 0755 ${WORKDIR}/bbxm-audio ${D}${sysconfdir}/init.d
