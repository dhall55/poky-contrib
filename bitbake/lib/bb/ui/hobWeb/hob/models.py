...
class BuildLogs(models.Model):
    buildConfig = models.ForeignKey(BuildConfig,null=True)
    operator = models.ForeignKey(Operator,null=True)
    types = models.CharField(null=True,max_length=100,blank=True)
    logs = models.TextField(max_length=200, blank=True,verbose_name='packageOrimage_logs')
    status = models.BooleanField(default=True)
    create_date = models.DateTimeField(auto_now=True, blank=True)
    class Meta:
        db_table = u'buildLogs'

class TreeModel(models.Model):
    types = models.CharField(null=True,max_length=50,blank=True)
    name = models.CharField(null=True,max_length=200,blank=True)
    license = models.CharField(null=True,max_length=200,blank=True)
    group = models.CharField(null=True,max_length=100,blank=True)
    description = models.TextField(null=True)
    size = models.IntegerField(null=True,default=0)
    pkg_parent = models.CharField(null=True,max_length=200,blank=True)
    is_included = models.BooleanField(default=False)
    brought_in_by = models.CharField(null=True,max_length=100,blank=True)
    create_date = models.DateTimeField(null=True,auto_now=True,blank=True)
    operator = models.ForeignKey(Operator,null=True)
    class Meta:
