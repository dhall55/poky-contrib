;(function($){
	...
	$.skygqbox.setPosition = function(){
		...
		var l = $('#layers').offset().left+20;
		var t = $('#layers').offset().top+160;
		...
		switch($.o.s.position){
			case "my":
				...
				if ( !($.browser.msie && $.browser.version < 7)) { // For IE6
