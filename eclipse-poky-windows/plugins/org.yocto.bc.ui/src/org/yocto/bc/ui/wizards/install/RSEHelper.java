...
public class RSEHelper {
	...
	public static IHostFile getRemoteHostFile(IRemoteConnection connection, String remoteFilePath, IProgressMonitor monitor){
		assert(connection!=null);
		monitor.beginTask(Messages.InfoDownload, 100);
		
		
		try {
			IHost host = getRemoteConnectionByName(connection.getName());
	...
	public static Process runCommandRemote(IHost connection, String initialDir,
		...
		String remoteCommand = remoteCommandPath + " " + arguments +  CMD_DELIMITER + EXIT_CMD;
